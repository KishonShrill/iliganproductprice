...
const ProductCard = ({ item, onAdd, onViewHistory }) => {
    const { settings } = useSettings();
    return (
        <div className={`product-card ${!settings.hidePhotos && 'grid-cols-2'} cursor-pointer relative group flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white p-3 shadow-sm transition-all duration-300 hover:shadow-lg`}
