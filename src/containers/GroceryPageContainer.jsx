...
import { addToCart, clearAllCart, clearLocationCart, removeFromCart, updateQuantityFromCart } from "../redux/actions/cartActions";
...
const mapDispatchToProps = (dispatch) => ({
    ...
    updateQuantityFromCart: (id, quantity) => dispatch(updateQuantityFromCart(id, quantity)),
