...
const About = () => {
    ...
    return (
        <section id="about" className="py-20 bg-linear-to-br from-gray-50 to-orange-50 dark:from-gray-800 dark:to-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 max-md:gap-6 items-center">
                    {/* Left Content */}
                    <div>
                        <div className="inline-flex items-center bg-linear-to-r from-[#ee4d2d]/10 to-orange-100 dark:from-white dark:to-orange-50 px-4 py-2 rounded-full text-[#ee4d2d] font-medium text-sm mb-6">
                        ...
                        {values.map((value, index) => (
                            ...
                            >
                                <div className='max-sm:flex max-sm:gap-4 max-sm:mb-2'>
                                    <div className={`w-12 h-12 max-sm:my-auto bg-linear-to-br from-[#ee4d2d] to-[#ff6b47] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                ...
                {/* <div className="mt-20 bg-white dark:bg-gray-700 rounded-3xl p-8 md:p-12 shadow-lg border dark:border-gray-600">
